...
public class ReportInfoGetter  
{
	...
	private String call_list_date; //added by atul dayal 7-11-2014
	private String Recordtime;  // added by Atul Dayal 8/11/2014
    private double best_score_computed; // added by Atul Dayal 28/10/2014
    private double best_score_actual_computed; // added by Atul Dayal 28/10/2014
    private double sum_computed_marks_roundoff; // added by Atul Dayal 28/10/2014
    private double sum_actual_computed_marks_roundoff; // added by Atul Dayal 28/10/2014
    private double sum_computed_marks_old; // added by Atul Dayal 28/10/2014
    private double sum_actual_computed_marks_old; // added by Atul Dayal 28/10/2014
    private double computed_Marks_roundoff;  // added by Atul Dayal 28/10/2014
    private double actual_computed_marks_roundoff; // added by Atul Dayal 28/10/2014
    private String RecordInsertTime; //added by atul dayal
    private String RecordModificationTime;//added by atul dayal
    ...
    private double totalscore; //arush
    private double totalscorewithoutwtg; //arush
    ...
    private String primaryEmailId;//Add by Dheeraj 1 June 2013
  //agam starts 17th June 2013
    private String preferredBranch1;
    private String preferredBranch2;
    private String preferredBranch3;//agam ends
    private String DEISTAFF;//added by agam - agam starts
    private String dei_student;
    private String marks_obtained;
    private String computedmarks;
    private String actual_computed_marks;
    private String percen;
    private  String totMarks;//agam ends
 // Arush Start 19th Oct ,2013
    private String deistudent;
    private String staffward;
    private String component_group ;// Arush ends
    
    // Jitendra Starts Dec 21, 2013
    private String totalStudents;
    private String totalStudentsPerTest;	// Jitendra Ends
    private String format; // Added by Jitendra (Dharna) Feb 13, 2014
	private String pathSeperator;
    
    private String application_number ; // Arush on 07-03-14
    private String user_name ;// Arush on 07-03-14
    private String application_type ; // Arush on 07-03-14
    private int number_of_times ;// Arush on 07-03-14
    private String number_of_times_active ;// Arush on 07-03-14
    private String cut_off_number_active ;// Arush on 07-03-14
    private int cos_seats ;// Arush on 07-03-14
    private int limit ;// Arush on 07-03-14
	private String boardName;
	private String staffCode;
  //Added by Arjun on 04-04-2014
    private String paperCode1;
    private String paperCode2;
    private String paperCode3;
    private String paperCode4;
  //Added by Arjun on 04-04-2014 ends here
    
    private String flag1;
    private String flag2;
    
    private String agregate_percentage ;
    private String minimum_agregate ;
    private int runNo;
	...
	public void setEntranceTestMarks(String entranceTestMarks) {
		this.entranceTestMarks = entranceTestMarks;
	}

	//Dharna for duplicate students
	...
	public void setSessiondates(String sessiondates) {
	...
	//agam starts
	public String getPreferredBranch1() {
		return preferredBranch1;
	}

	public void setPreferredBranch1(String preferredBranch1) {
		this.preferredBranch1 = preferredBranch1;
	}

	public String getPreferredBranch2() {
		return preferredBranch2;
	}

	public void setPreferredBranch2(String preferredBranch2) {
		this.preferredBranch2 = preferredBranch2;
	}

	public String getPreferredBranch3() {
		return preferredBranch3;
	}

	public void setPreferredBranch3(String preferredBranch3) {
		this.preferredBranch3 = preferredBranch3;
	}//agam ends
	
	//added by agam - agam starts
	public String getDEISTAFF() {
		return DEISTAFF;
	}

	public void setDEISTAFF(String deistaff) {
		DEISTAFF = deistaff;
	}
	...
	public String getActual_computed_marks() {
		return actual_computed_marks;
	}

	public void setActual_computed_marks(String actual_computed_marks) {
		this.actual_computed_marks = actual_computed_marks;
	} 
	...
	public String getStaffward() {
		return staffward;
	}

	public void setStaffward(String staffward) {
		this.staffward = staffward;
	}
	...
	public String getTotalStudentsPerTest() {
		return totalStudentsPerTest;
	}

	public void setTotalStudentsPerTest(String totalStudentsPerTest) {
		this.totalStudentsPerTest = totalStudentsPerTest;
	}
	...
	public String getNumber_of_times_active() {
		return number_of_times_active;
	}

	public void setNumber_of_times_active(String number_of_times_active) {
		this.number_of_times_active = number_of_times_active;
	}
	...
	public int getCos_seats() {
		return cos_seats;
	}

	public void setCos_seats(int cos_seats) {
		this.cos_seats = cos_seats;
	}

	public String getPaperCode1() {
		return paperCode1;
	}

	public void setPaperCode1(String paperCode1) {
		this.paperCode1 = paperCode1;
	}

	public String getPaperCode2() {
		return paperCode2;
	}

	public void setPaperCode2(String paperCode2) {
		this.paperCode2 = paperCode2;
	}

	public String getPaperCode3() {
		return paperCode3;
	}

	public void setPaperCode3(String paperCode3) {
		this.paperCode3 = paperCode3;
	}

	public String getPaperCode4() {
		return paperCode4;
	}

	public void setPaperCode4(String paperCode4) {
		this.paperCode4 = paperCode4;
	}
	...
	public double getTotalscorewithoutwtg() {
		return totalscorewithoutwtg;
	}

	public void setTotalscorewithoutwtg(double totalscorewithoutwtg) {
		this.totalscorewithoutwtg = totalscorewithoutwtg;
	}
	...
	public String getAgregate_percentage() {
		return agregate_percentage;
	}

	public void setAgregate_percentage(String agregate_percentage) {
		this.agregate_percentage = agregate_percentage;
	}

	public String getMinimum_agregate() {
		return minimum_agregate;
	}

	public void setMinimum_agregate(String minimum_agregate) {
		this.minimum_agregate = minimum_agregate;
	}

	public double getComputed_Marks_roundoff() {
		return computed_Marks_roundoff;
	}

	public void setComputed_Marks_roundoff(double computed_Marks_roundoff) {
		this.computed_Marks_roundoff = computed_Marks_roundoff;
	}

	public double getActual_computed_marks_roundoff() {
		return actual_computed_marks_roundoff;
	}

	public void setActual_computed_marks_roundoff(
			double actual_computed_marks_roundoff) {
		this.actual_computed_marks_roundoff = actual_computed_marks_roundoff;
	}

	public double getSum_computed_marks_roundoff() {
		return sum_computed_marks_roundoff;
	}

	public void setSum_computed_marks_roundoff(double sum_computed_marks_roundoff) {
		this.sum_computed_marks_roundoff = sum_computed_marks_roundoff;
	}

	public double getSum_actual_computed_marks_roundoff() {
		return sum_actual_computed_marks_roundoff;
	}

	public void setSum_actual_computed_marks_roundoff(
			double sum_actual_computed_marks_roundoff) {
		this.sum_actual_computed_marks_roundoff = sum_actual_computed_marks_roundoff;
	}

	public double getSum_computed_marks_old() {
		return sum_computed_marks_old;
	}

	public void setSum_computed_marks_old(double sum_computed_marks_old) {
		this.sum_computed_marks_old = sum_computed_marks_old;
	}

	public double getSum_actual_computed_marks_old() {
		return sum_actual_computed_marks_old;
	}

	public void setSum_actual_computed_marks_old(
			double sum_actual_computed_marks_old) {
		this.sum_actual_computed_marks_old = sum_actual_computed_marks_old;
	}

	public double getBest_score_computed() {
		return best_score_computed;
	}

	public void setBest_score_computed(double best_score_computed) {
		this.best_score_computed = best_score_computed;
	}

	public double getBest_score_actual_computed() {
		return best_score_actual_computed;
	}

	public void setBest_score_actual_computed(double best_score_actual_computed) {
		this.best_score_actual_computed = best_score_actual_computed;
	}
	...
	public String getCall_list_date() {
		return call_list_date;
	}

	public void setCall_list_date(String call_list_date) {
		this.call_list_date = call_list_date;
	}
	...
	public String getEligibiltiy() {
		return eligibiltiy;
	}

	public void setEligibiltiy(String eligibiltiy) {
		this.eligibiltiy = eligibiltiy;
	}
